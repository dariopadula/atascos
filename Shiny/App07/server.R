...
diasIntercept <- reactive({
  ...
  if(!("ALL" %in% input$varAnio  | is.null(input$varAnio))) {
    diasAnio = rownames(subset(dsma, anio %in% input$varAnio))
  }
  
  ### FIn de semana
  diasMes = rownames(dsma)
  if(!("ALL" %in% input$varMes  | is.null(input$varMes))) {
...
datCorAgg = eventReactive(input$run, {
  ...
  datAgg = datFiltro %>% group_by_at(vars(dplyr::one_of(varsGroup))) %>%
    ...
    mutate(content = paste(sep = "<br/>",
                      paste("<b><a href='http://www.samurainoodle.com'>ID Segmentno</a></b>:",ID_segmento),
                      paste("<b><a href='http://www.samurainoodle.com'>Total</a></b>:",nCorte),
                      paste("<b><a href='http://www.samurainoodle.com'>% Tiempo</a></b>:",porcTimeCorte),
                      paste("<b><a href='http://www.samurainoodle.com'>% Fecha min</a></b>:",DateMin),
                      paste("<b><a href='http://www.samurainoodle.com'>% Fecha max</a></b>:",DateMax)),
...
datAScopAgg = eventReactive(input$run, {
  ...
  datAgg =  datFiltro %>% group_by_at(vars(dplyr::one_of(varsGroup))) %>%
    ...
    mutate(content = paste(sep = "<br/>",
                           paste("<b><a href='http://www.samurainoodle.com'>Total reportes</a></b>:",count),
                           "<b><a href='http://www.samurainoodle.com'>Sentido</a></b>:",
                           paste("<a href='http://www.samurainoodle.com'>Calle</a>:",avenida),
                           paste("<a href='http://www.samurainoodle.com'>Desde</a>:",desde),
                           paste("<a href='http://www.samurainoodle.com'>Hacia</a>:",hacia),
                           "<em><b><a href='http://www.samurainoodle.com'>Volumen</a></em></b></font>:",
                           paste("<a href='http://www.samurainoodle.com'>Prom 5 minutos</a>:",valume_mean),
                           paste("<a href='http://www.samurainoodle.com'>SD</a>:",valume_sd),
                           paste("<a href='http://www.samurainoodle.com'>Máximo 5 minutos</a>:",valume_max),
                           paste("<a href='http://www.samurainoodle.com'>Mínimo 5 minutos</a>:",valume_min),
                           paste("<a href='http://www.samurainoodle.com'>Prom Intevalo</a>:",valume_intTime),
                           paste("<b><a href='http://www.samurainoodle.com'>Velocidad Promedio</a></b>:",velocidad_mean),
                           paste("<b><a href='http://www.samurainoodle.com'>% Reporte congestión</a></b>:",PorcCongest)))
...
diasInterceptHeat <- reactive({
  ### Anio
  diasAnio = rownames(dsma)
  if(!("ALL" %in% input$varAnioHeat  | is.null(input$varAnioHeat))) {
    diasAnio = rownames(subset(dsma, anio %in% input$varAnioHeat))
  }
  
  ### FIn de semana
  diasMes = rownames(dsma)
  if(!("ALL" %in% input$varMesHeat  | is.null(input$varMesHeat))) {
